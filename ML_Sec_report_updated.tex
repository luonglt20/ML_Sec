...
\begin{enumerate}
    \item D. Jin, E. Pan, N. Oufettoho, X. S. Weng, H. Fang, and P. Szolovits,
    ``What Disease does this Patient Have? A Large-scale Open Domain
    Question Answering Dataset from Medical Exams,'' \textit{Applied
    Sciences}, vol. 11, no. 14, p. 6421, 2021.

    \item P. Lewis \textit{et al.}, ``Retrieval-augmented generation for
    knowledge-intensive NLP tasks,'' in \textit{Advances in Neural
    Information Processing Systems (NeurIPS)}, vol. 33, pp. 9459--9474,
    2020.

    \item Q. Wu \textit{et al.}, ``AutoGen: Enabling next-gen LLM
    applications via multi-agent conversation,'' \textit{arXiv preprint
    arXiv:2308.08155}, 2023.

    \item Y. Liu, Y. Jia, R. Geng, J. Jia, and N. Z. Gong, ``Formalizing
    and benchmarking prompt injection attacks and defenses,'' in
    \textit{33rd USENIX Security Symposium (USENIX Security 24)},
    pp. 1831--1847, 2024. Code:
    \url{https://github.com/liu00222/Open-Prompt-Injection}.

    \item S. Chen, J. Piet, C. Sitawarin, and D. Wagner, ``StruQ:
    Defending Against Prompt Injection with Structured Queries,'' in
    \textit{34th USENIX Security Symposium (USENIX Security 25)},
    pp. 2383--2400, USENIX Association, 2025. Code:
    \url{https://github.com/Sizhe-Chen/StruQ}.

    \item S. Chen, A. Zharmagambetov, S. Mahloujifar, K. Chaudhuri,
    D. Wagner, and C. Guo, ``SecAlign: Defending Against Prompt
    Injection with Preference Optimization,'' in \textit{Proceedings of
    the 2025 ACM SIGSAC Conference on Computer and Communications
    Security (CCS '25)}, pp. 2833--2847, ACM, 2025.
    doi: \url{https://doi.org/10.1145/3719027.3744836}. Code:
